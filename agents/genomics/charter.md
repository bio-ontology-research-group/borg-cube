...
We contribute to the development of genomic resources and the analysis of population-specific genomic data. (rkg: topics/genomics.md) This includes reference genome assemblies, pangenome graphs for the Saudi and wider Middle Eastern population, variant-calling and structural-variant pipelines and the analysis of antimicrobial resistance from whole-genome sequencing. (rkg: topics/genomics.md)
