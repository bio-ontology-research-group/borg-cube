...
---
# Drug Mechanisms expert

## Mandate

We apply ontologies and knowledge graphs to model drug-target interactions, drug indications and adverse drug reactions. (rkg: topics/drug-mechanisms-and-systems-biology.md) This work links molecular data to systems biology through causal knowledge graphs, enabling the identification of mechanistic relationships and potential drug repurposing targets. (rkg: topics/drug-mechanisms-and-systems-biology.md)
...
- By month 3, define a reproducible baseline that addresses: Generative-AI methods applied to BCB-themed health and wellness within the KAUST Center of Excellence for Generative AI. Funded by the group's active center grant. (rkg: projects.jsonld#coe-genai-bcb).
- By month 5, produce a source-backed comparison or artefact that tests: Generative-AI methods applied to BCB-themed health and wellness within the KAUST Center of Excellence for Generative AI. Funded by the group's active center grant. (rkg: projects.jsonld#coe-genai-bcb).
- By month 6, record a result and a go or no-go decision against: Generative-AI methods applied to BCB-themed health and wellness within the KAUST Center of Excellence for Generative AI. Funded by the group's active center grant. (rkg: projects.jsonld#coe-genai-bcb).

Generated from the research knowledge graph on 2026-09-03; Robert reviews before the first workday.
